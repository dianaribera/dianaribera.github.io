const apiURL = 'https://api.openweathermap.org/data/2.5/weather?lat=42.0380399&lon=-111.4048681&units=imperial&appid=3738fdc9983f5ba04c511ad6a0cc5685';
...
fetch(apiURL)
  ...
  const forecastURL = 'https://api.openweathermap.org/data/2.5/forecast?lat=42.0380399&lon=-111.4048681&units=imperial&appid=3738fdc9983f5ba04c511ad6a0cc5685';
  ...
  document.getElementById("fish-events").appendChild(ul);
});